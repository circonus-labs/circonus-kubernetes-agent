...
var rootCmd = &cobra.Command{
	...
	Short: "Send Kubernetes metrics to Circonus",
	Long: `An agent deployed to a Kubernetes cluster which collects metrics on cluster
and component performance forwarding the metrics to Circonus.`,
